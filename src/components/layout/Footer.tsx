    ...
    <footer className="bg-dark pt-24 pb-12 text-white">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          ...
          <div>
            <h4 className="text-xl font-bold mb-6">Profil</h4>
            <ul className="space-y-4 text-white/60">
              <li><Link to="/profil/sambutan" className="hover:text-accent transition-colors">Sambutan Kaprodi</Link></li>
              <li><Link to="/profil/sejarah" className="hover:text-accent transition-colors">Sejarah</Link></li>
              <li><Link to="/profil/visi-misi" className="hover:text-accent transition-colors">Visi & Misi</Link></li>
              <li><Link to="/faculty" className="hover:text-accent transition-colors">Staf Pengajar</Link></li>
              <li><Link to="/profil/alumni" className="hover:text-accent transition-colors">Alumni</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-white/60">
              <li><Link to="/programs/s1-pendidikan" className="hover:text-accent transition-colors">S1 Pendidikan Biologi</Link></li>
              <li><Link to="/programs/s1-biologi" className="hover:text-accent transition-colors">S1 Biologi</Link></li>
              <li><Link to="/programs/s2-pendidikan" className="hover:text-accent transition-colors">S2 Pendidikan Biologi</Link></li>
              <li><Link to="/akademik/pengaturan" className="hover:text-accent transition-colors">Pengaturan Akademik</Link></li>
            </ul>
          </div>
