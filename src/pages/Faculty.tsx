  ...
  return (
    <section className="py-32 bg-neutral min-h-screen">
      <div className="container mx-auto px-6">
        <SectionHeading 
          title="Staf Pengajar" 
          subtitle="Tenaga pengajar profesional yang berdedikasi dalam pengembangan sains hayat di Jurusan Biologi." 
        />
        ...
        <div className="flex flex-col lg:flex-row gap-6 mb-16 items-center justify-center">
          <div className="relative w-full lg:max-w-xl">
            ...
            <input 
              type="text" 
              placeholder="Cari nama atau bidang keahlian dosen..."
              className="w-full pl-12 pr-6 py-4 bg-white rounded-2xl border border-primary/10 focus:outline-none focus:border-accent transition-all shadow-sm text-center lg:text-left"
              value={searchTerm}
